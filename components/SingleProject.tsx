...
const SingleProject = (props: Props) => {
  return (
    <motion.div
      ...
      className="flex flex-col gap-10 w-[80%] min-h-[80%] bg-[#202020] rounded-3xl m-auto font-bold uppercase text-center p-10 text-m mb-10 hover:shadow-md hover:bg-[#252525]  transition-shadow hover:ease-in-out hover:duration-300"
    >
